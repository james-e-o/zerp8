...
export default function LoginPage() {
  ...
  return (
    ...
    <div className="bg-background flex h-full overflow-y-auto flex-col items-center justify-center gap-6 p-6 md:p-10">
          ...
          <form onSubmit={handleSubmit}>
            <FieldGroup>
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <p className="text-electric font-semibold mb-4">Echelon Trader</p>
                <FieldDescription>
                  Don&apos;t have an account? <Link href="/accounts/signup" className="text-electric font-semibold hover:underline">Sign up</Link>
                </FieldDescription>
              </div>
             <Field>
              ...
              <Field>
                <Button disabled={isLoading} className={'bg-linear-to-br from-60% from-navy to-electric'} type="submit">{isLoading&&<Spinner spinning={isLoading}/>}Login</Button>
              </Field>
