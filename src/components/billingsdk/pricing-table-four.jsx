    ...
    <section className={cn(sectionVariants({ size, theme }), className)}>
      ...
      {theme === "classic" && (
        <>
          ...
          <div
            className="bg-primary/5 absolute top-1/2 left-1/2 h-96 w-96 -translate-x-1/2 -translate-y-1/2 rounded-full blur-3xl" />
          <div
            className="bg-secondary/5 absolute top-1/4 right-1/4 h-64 w-64 rounded-full blur-2xl" />
        </>
      )}
      <div className="relative container mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center">
          ...
          {showBillingToggle && (
            <div
              className={cn("mx-auto mt-8 flex justify-center", toggleVariants({ theme }))}>
              <RadioGroup
                ...
                <div
                  ...
                  <Label
                    ...
                    {yearlyPriceDiscount > 0 && (
                      <span
                        className="bg-primary/10 text-primary border-primary/20 ml-1 rounded border px-2 py-0.5 text-xs font-medium">
          ...
          {plans.map((plan, index) => (
            <motion.div
              ...
              {theme === "classic" && plan.highlight && (
                <div
                  className="via-primary absolute -top-px left-1/2 h-px w-32 -translate-x-1/2 bg-gradient-to-r from-transparent to-transparent" />
              )}
                ...
                <div className="flex h-full flex-col">
                  ...
                  <div className="mb-4 flex items-start gap-4">
                    <div className="flex-1">
                      <h3
                        className={cn("mb-1 text-xl font-bold", theme === "classic" ? "text-lg" : "")}>
                        {plan.title}
                      </h3>
                      <p
                        className={cn(
                        ...
                        {isAnnually ? (
                          <div className="flex items-baseline gap-1">
                            ...
                            {calculateDiscount(plan.monthlyPrice, plan.yearlyPrice) > 0 && (
                              <span
                                className={cn("ml-2 text-xs", theme === "classic"
                  ...
                  <div className="mb-6">
                    <Button
                      ...
                      className={cn(buttonVariants({ theme }), !plan.highlight &&
                        theme === "minimal" &&
                      ...
                      {theme === "classic" && plan.highlight && (
                        <div
                          className="absolute inset-0 translate-x-[-100%] bg-gradient-to-r from-white/0 via-white/10 to-white/0 transition-transform duration-700 hover:translate-x-[100%]" />
                      )}
                    </Button>
                  </div>
                    ...
                    <ul className="space-y-3">
                      {plan.features.map((feature, featureIndex) => (
                        <motion.li
                          ...
                          <span
                            className={cn("text-sm", theme === "classic"
                              ? "text-foreground/90"
